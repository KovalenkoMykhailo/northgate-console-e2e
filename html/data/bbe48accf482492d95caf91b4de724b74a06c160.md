...
- Name: planted.spec.ts >> Spec gaps @planted >> Ada Chen table balance matches GET /accounts
- Location: tests/planted.spec.ts:65:7
...
Locator:  locator('[data-testid="account-row"][data-id="acc-3"]').getByTestId('account-balance')
Expected: "4200.50"
Received: "4200"
Timeout:  2000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="account-row"][data-id="acc-3"]').getByTestId('account-balance')
    21 × locator resolved to <td data-testid="account-balance">4200</td>
       - unexpected value "4200"
