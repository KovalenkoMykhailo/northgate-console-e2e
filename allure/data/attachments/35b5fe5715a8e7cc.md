...
- Name: planted.spec.ts >> Spec gaps @planted >> currency filter keeps only that currency
- Location: tests/planted.spec.ts:31:7
...
Locator:  getByTestId('account-row').nth(1)
Expected: "EUR"
Received: "USD"
Timeout:  2000ms
...
Call log:
  ...
  - waiting for getByTestId('account-row').nth(1)
    21 × locator resolved to <tr data-id="acc-2" data-currency="USD" data-status="Active" data-testid="account-row">…</tr>
       - unexpected value "USD"
