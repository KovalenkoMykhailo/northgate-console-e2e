...
- Name: planted.spec.ts >> Spec gaps @planted >> freeze persists on next GET and reload
- Location: tests/planted.spec.ts:76:7
...
Locator:  locator('[data-testid="account-row"][data-id="acc-1"]')
Expected: "Frozen"
Received: "Active"
Timeout:  2000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="account-row"][data-id="acc-1"]')
    19 × locator resolved to <tr data-id="acc-1" data-currency="EUR" data-status="Active" data-testid="account-row">…</tr>
